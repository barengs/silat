...
export default function Button({
    ...
    const baseStyle = 'inline-flex items-center justify-center font-medium rounded-lg shadow-sm border transition-colors focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed';
